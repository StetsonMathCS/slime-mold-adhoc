...
#ifndef OPLSR_HEADER_H
#define OPLSR_HEADER_H
 ...
 * \ingroup oplsr
 *
 * The basic layout of any packet in OPLSR is as follows (omitting IP and
 * UDP headers):
  \verbatim
    0                   1                   2                   3
