...
def module_init():
    root_module = Module('ns.oplsr', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## oplsr-helper.h (module 'oplsr'): ns3::OplsrHelper [class]
    module.add_class('OplsrHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> [class]
    module.add_class('CallbackImpl', import_from_module='ns.core', template_parameters=['void', 'const ns3::oplsr::PacketHeader &', 'const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'], parent=root_module['ns3::CallbackImplBase'])
    ...
    module.add_container('std::vector< ns3::oplsr::MessageHeader >', 'ns3::oplsr::MessageHeader', container_type=u'vector')
    ...
    ## Register a nested module for the namespace oplsr
    
    nested_module = module.add_cpp_namespace('oplsr')
    register_types_ns3_oplsr(nested_module)
...
def register_types_ns3_oplsr(module):
    root_module = module.get_root()
    
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::Association [struct]
    module.add_class('Association')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple [struct]
    module.add_class('AssociationTuple')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple [struct]
    module.add_class('DuplicateTuple')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple [struct]
    module.add_class('IfaceAssocTuple')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple [struct]
    module.add_class('LinkTuple')
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader [class]
    module.add_class('MessageHeader', parent=root_module['ns3::Header'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::MessageType [enumeration]
    module.add_enum('MessageType', ['HELLO_MESSAGE', 'TC_MESSAGE', 'MID_MESSAGE', 'HNA_MESSAGE'], outer_class=root_module['ns3::oplsr::MessageHeader'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello [struct]
    module.add_class('Hello', outer_class=root_module['ns3::oplsr::MessageHeader'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::LinkMessage [struct]
    module.add_class('LinkMessage', outer_class=root_module['ns3::oplsr::MessageHeader::Hello'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna [struct]
    module.add_class('Hna', outer_class=root_module['ns3::oplsr::MessageHeader'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Association [struct]
    module.add_class('Association', outer_class=root_module['ns3::oplsr::MessageHeader::Hna'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Mid [struct]
    module.add_class('Mid', outer_class=root_module['ns3::oplsr::MessageHeader'])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc [struct]
    module.add_class('Tc', outer_class=root_module['ns3::oplsr::MessageHeader'])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::MprSelectorTuple [struct]
    module.add_class('MprSelectorTuple')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple [struct]
    module.add_class('NeighborTuple')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple::Status [enumeration]
    module.add_enum('Status', ['STATUS_NOT_SYM', 'STATUS_SYM'], outer_class=root_module['ns3::oplsr::NeighborTuple'])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::OplsrState [class]
    module.add_class('OplsrState')
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::PacketHeader [class]
    module.add_class('PacketHeader', parent=root_module['ns3::Header'])
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    typehandlers.add_type_alias(u'void ( * ) ( ns3::oplsr::PacketHeader const &, ns3::oplsr::MessageList const & )', u'ns3::oplsr::RoutingProtocol::PacketTxRxTracedCallback')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::oplsr::PacketHeader const &, ns3::oplsr::MessageList const & )*', u'ns3::oplsr::RoutingProtocol::PacketTxRxTracedCallback*')
    typehandlers.add_type_alias(u'void ( * ) ( ns3::oplsr::PacketHeader const &, ns3::oplsr::MessageList const & )&', u'ns3::oplsr::RoutingProtocol::PacketTxRxTracedCallback&')
    typehandlers.add_type_alias(u'void ( * ) ( uint32_t )', u'ns3::oplsr::RoutingProtocol::TableChangeTracedCallback')
    typehandlers.add_type_alias(u'void ( * ) ( uint32_t )*', u'ns3::oplsr::RoutingProtocol::TableChangeTracedCallback*')
    typehandlers.add_type_alias(u'void ( * ) ( uint32_t )&', u'ns3::oplsr::RoutingProtocol::TableChangeTracedCallback&')
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry [struct]
    module.add_class('RoutingTableEntry')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple [struct]
    module.add_class('TopologyTuple')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple [struct]
    ...
    module.add_container('std::vector< ns3::oplsr::MessageHeader::Hello::LinkMessage >', 'ns3::oplsr::MessageHeader::Hello::LinkMessage', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::MessageHeader::Hna::Association >', 'ns3::oplsr::MessageHeader::Hna::Association', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::MprSelectorTuple >', 'ns3::oplsr::MprSelectorTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::NeighborTuple >', 'ns3::oplsr::NeighborTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::TwoHopNeighborTuple >', 'ns3::oplsr::TwoHopNeighborTuple', container_type=u'vector')
    module.add_container('ns3::oplsr::MprSet', 'ns3::Ipv4Address', container_type=u'set')
    module.add_container('std::vector< ns3::oplsr::LinkTuple >', 'ns3::oplsr::LinkTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::TopologyTuple >', 'ns3::oplsr::TopologyTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::IfaceAssocTuple >', 'ns3::oplsr::IfaceAssocTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::AssociationTuple >', 'ns3::oplsr::AssociationTuple', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::Association >', 'ns3::oplsr::Association', container_type=u'vector')
    module.add_container('std::vector< ns3::oplsr::RoutingTableEntry >', 'ns3::oplsr::RoutingTableEntry', container_type=u'vector')
    module.add_container('std::set< unsigned int >', 'unsigned int', container_type=u'set')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::MessageHeader >', u'ns3::oplsr::MessageList')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::MessageHeader >*', u'ns3::oplsr::MessageList*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::MessageHeader >&', u'ns3::oplsr::MessageList&')
    typehandlers.add_type_alias(u'std::set< ns3::Ipv4Address >', u'ns3::oplsr::MprSet')
    typehandlers.add_type_alias(u'std::set< ns3::Ipv4Address >*', u'ns3::oplsr::MprSet*')
    typehandlers.add_type_alias(u'std::set< ns3::Ipv4Address >&', u'ns3::oplsr::MprSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::MprSelectorTuple >', u'ns3::oplsr::MprSelectorSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::MprSelectorTuple >*', u'ns3::oplsr::MprSelectorSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::MprSelectorTuple >&', u'ns3::oplsr::MprSelectorSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::LinkTuple >', u'ns3::oplsr::LinkSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::LinkTuple >*', u'ns3::oplsr::LinkSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::LinkTuple >&', u'ns3::oplsr::LinkSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::NeighborTuple >', u'ns3::oplsr::NeighborSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::NeighborTuple >*', u'ns3::oplsr::NeighborSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::NeighborTuple >&', u'ns3::oplsr::NeighborSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::TwoHopNeighborTuple >', u'ns3::oplsr::TwoHopNeighborSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::TwoHopNeighborTuple >*', u'ns3::oplsr::TwoHopNeighborSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::TwoHopNeighborTuple >&', u'ns3::oplsr::TwoHopNeighborSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::TopologyTuple >', u'ns3::oplsr::TopologySet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::TopologyTuple >*', u'ns3::oplsr::TopologySet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::TopologyTuple >&', u'ns3::oplsr::TopologySet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::DuplicateTuple >', u'ns3::oplsr::DuplicateSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::DuplicateTuple >*', u'ns3::oplsr::DuplicateSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::DuplicateTuple >&', u'ns3::oplsr::DuplicateSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::IfaceAssocTuple >', u'ns3::oplsr::IfaceAssocSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::IfaceAssocTuple >*', u'ns3::oplsr::IfaceAssocSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::IfaceAssocTuple >&', u'ns3::oplsr::IfaceAssocSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::AssociationTuple >', u'ns3::oplsr::AssociationSet')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::AssociationTuple >*', u'ns3::oplsr::AssociationSet*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::AssociationTuple >&', u'ns3::oplsr::AssociationSet&')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::Association >', u'ns3::oplsr::Associations')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::Association >*', u'ns3::oplsr::Associations*')
    typehandlers.add_type_alias(u'std::vector< ns3::oplsr::Association >&', u'ns3::oplsr::Associations&')
...
def register_methods(root_module):
    ...
    register_Ns3OplsrHelper_methods(root_module, root_module['ns3::OplsrHelper'])
    ...
    register_Ns3CallbackImpl__Void_Const_ns3OplsrPacketHeader___amp___Const_stdVector__lt__ns3OplsrMessageHeader__stdAllocator__lt__ns3OplsrMessageHeader__gt_____gt_____amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, root_module['ns3::CallbackImpl< void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >'])
    ...
    register_Ns3OplsrAssociation_methods(root_module, root_module['ns3::oplsr::Association'])
    register_Ns3OplsrAssociationTuple_methods(root_module, root_module['ns3::oplsr::AssociationTuple'])
    register_Ns3OplsrDuplicateTuple_methods(root_module, root_module['ns3::oplsr::DuplicateTuple'])
    register_Ns3OplsrIfaceAssocTuple_methods(root_module, root_module['ns3::oplsr::IfaceAssocTuple'])
    register_Ns3OplsrLinkTuple_methods(root_module, root_module['ns3::oplsr::LinkTuple'])
    register_Ns3OplsrMessageHeader_methods(root_module, root_module['ns3::oplsr::MessageHeader'])
    register_Ns3OplsrMessageHeaderHello_methods(root_module, root_module['ns3::oplsr::MessageHeader::Hello'])
    register_Ns3OplsrMessageHeaderHelloLinkMessage_methods(root_module, root_module['ns3::oplsr::MessageHeader::Hello::LinkMessage'])
    register_Ns3OplsrMessageHeaderHna_methods(root_module, root_module['ns3::oplsr::MessageHeader::Hna'])
    register_Ns3OplsrMessageHeaderHnaAssociation_methods(root_module, root_module['ns3::oplsr::MessageHeader::Hna::Association'])
    register_Ns3OplsrMessageHeaderMid_methods(root_module, root_module['ns3::oplsr::MessageHeader::Mid'])
    register_Ns3OplsrMessageHeaderTc_methods(root_module, root_module['ns3::oplsr::MessageHeader::Tc'])
    register_Ns3OplsrMprSelectorTuple_methods(root_module, root_module['ns3::oplsr::MprSelectorTuple'])
    register_Ns3OplsrNeighborTuple_methods(root_module, root_module['ns3::oplsr::NeighborTuple'])
    register_Ns3OplsrOplsrState_methods(root_module, root_module['ns3::oplsr::OplsrState'])
    register_Ns3OplsrPacketHeader_methods(root_module, root_module['ns3::oplsr::PacketHeader'])
    register_Ns3OplsrRoutingProtocol_methods(root_module, root_module['ns3::oplsr::RoutingProtocol'])
    register_Ns3OplsrRoutingTableEntry_methods(root_module, root_module['ns3::oplsr::RoutingTableEntry'])
    register_Ns3OplsrTopologyTuple_methods(root_module, root_module['ns3::oplsr::TopologyTuple'])
    register_Ns3OplsrTwoHopNeighborTuple_methods(root_module, root_module['ns3::oplsr::TwoHopNeighborTuple'])
    return
...
def register_Ns3OplsrHelper_methods(root_module, cls):
    ## oplsr-helper.h (module 'oplsr'): ns3::OplsrHelper::OplsrHelper() [constructor]
    cls.add_constructor([])
    ## oplsr-helper.h (module 'oplsr'): ns3::OplsrHelper::OplsrHelper(ns3::OplsrHelper const & arg0) [constructor]
    cls.add_constructor([param('ns3::OplsrHelper const &', 'arg0')])
    ## oplsr-helper.h (module 'oplsr'): ns3::OplsrHelper * ns3::OplsrHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::OplsrHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## oplsr-helper.h (module 'oplsr'): void ns3::OplsrHelper::ExcludeInterface(ns3::Ptr<ns3::Node> node, uint32_t interface) [member function]
    cls.add_method('ExcludeInterface', 
                   'void', 
                   [param('ns3::Ptr< ns3::Node >', 'node'), param('uint32_t', 'interface')])
    ## oplsr-helper.h (module 'oplsr'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::OplsrHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## oplsr-helper.h (module 'oplsr'): void ns3::OplsrHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    ## oplsr-helper.h (module 'oplsr'): int64_t ns3::OplsrHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, visibility='protected', template_parameters=[u'ns3::oplsr::PacketHeader const&'])
    ## callback.h (module 'core'): static std::string ns3::CallbackImplBase::GetCppTypeid() [member function]
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, visibility='protected', template_parameters=[u'std::vector<ns3::oplsr::MessageHeader', u' std::allocator<ns3::oplsr::MessageHeader> > const&'])
    return
...
def register_Ns3CallbackImpl__Void_Const_ns3OplsrPacketHeader___amp___Const_stdVector__lt__ns3OplsrMessageHeader__stdAllocator__lt__ns3OplsrMessageHeader__gt_____gt_____amp___Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_Ns3Empty_methods(root_module, cls):
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl() [constructor]
    cls.add_constructor([])
    ## callback.h (module 'core'): ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::CallbackImpl(ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> const & arg0) [constructor]
    cls.add_constructor([param('ns3::CallbackImpl< void, ns3::oplsr::PacketHeader const &, std::vector< ns3::oplsr::MessageHeader, std::allocator< ns3::oplsr::MessageHeader > > const, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty > const &', 'arg0')])
    ## callback.h (module 'core'): static std::string ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::DoGetTypeid() [member function]
    cls.add_method('DoGetTypeid', 
                   'std::string', 
                   [], 
                   is_static=True)
    ## callback.h (module 'core'): std::string ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::GetTypeid() const [member function]
    cls.add_method('GetTypeid', 
                   'std::string', 
                   [], 
                   is_const=True, is_virtual=True)
    ## callback.h (module 'core'): void ns3::CallbackImpl<void, const ns3::oplsr::PacketHeader &, const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>::operator()(ns3::oplsr::PacketHeader const & arg0, std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > const & arg1) [member operator]
    cls.add_method('operator()', 
                   'void', 
                   [param('ns3::oplsr::PacketHeader const &', 'arg0'), param('std::vector< ns3::oplsr::MessageHeader > const &', 'arg1')], 
                   is_pure_virtual=True, is_virtual=True, custom_name=u'__call__')
...
def register_Ns3OplsrAssociation_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    cls.add_output_stream_operator()
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::Association::Association() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::Association::Association(ns3::oplsr::Association const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::Association const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::Association::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::Association::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3OplsrAssociationTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    cls.add_output_stream_operator()
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple::AssociationTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple::AssociationTuple(ns3::oplsr::AssociationTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::AssociationTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple::gatewayAddr [variable]
    cls.add_instance_attribute('gatewayAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple::netmask [variable]
    cls.add_instance_attribute('netmask', 'ns3::Ipv4Mask', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::AssociationTuple::networkAddr [variable]
    cls.add_instance_attribute('networkAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3OplsrDuplicateTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::DuplicateTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::DuplicateTuple(ns3::oplsr::DuplicateTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::DuplicateTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::ifaceList [variable]
    cls.add_instance_attribute('ifaceList', 'std::vector< ns3::Ipv4Address >', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::retransmitted [variable]
    cls.add_instance_attribute('retransmitted', 'bool', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::DuplicateTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3OplsrIfaceAssocTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    cls.add_output_stream_operator()
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple::IfaceAssocTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple::IfaceAssocTuple(ns3::oplsr::IfaceAssocTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::IfaceAssocTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple::ifaceAddr [variable]
    cls.add_instance_attribute('ifaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3OplsrLinkTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    cls.add_output_stream_operator()
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::LinkTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::LinkTuple(ns3::oplsr::LinkTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::LinkTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::asymTime [variable]
    cls.add_instance_attribute('asymTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::localIfaceAddr [variable]
    cls.add_instance_attribute('localIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::neighborIfaceAddr [variable]
    cls.add_instance_attribute('neighborIfaceAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::symTime [variable]
    cls.add_instance_attribute('symTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::LinkTuple::time [variable]
    cls.add_instance_attribute('time', 'ns3::Time', is_const=False)
    return

def register_Ns3OplsrMessageHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::MessageHeader(ns3::oplsr::MessageHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::MessageHeader() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello & ns3::oplsr::MessageHeader::GetHello() [member function]
    cls.add_method('GetHello', 
                   'ns3::oplsr::MessageHeader::Hello &', 
                   [])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello const & ns3::oplsr::MessageHeader::GetHello() const [member function]
    cls.add_method('GetHello', 
                   'ns3::oplsr::MessageHeader::Hello const &', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna & ns3::oplsr::MessageHeader::GetHna() [member function]
    cls.add_method('GetHna', 
                   'ns3::oplsr::MessageHeader::Hna &', 
                   [])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna const & ns3::oplsr::MessageHeader::GetHna() const [member function]
    cls.add_method('GetHna', 
                   'ns3::oplsr::MessageHeader::Hna const &', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): uint8_t ns3::oplsr::MessageHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::TypeId ns3::oplsr::MessageHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): uint16_t ns3::oplsr::MessageHeader::GetMessageSequenceNumber() const [member function]
    cls.add_method('GetMessageSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::MessageType ns3::oplsr::MessageHeader::GetMessageType() const [member function]
    cls.add_method('GetMessageType', 
                   'ns3::oplsr::MessageHeader::MessageType', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Mid & ns3::oplsr::MessageHeader::GetMid() [member function]
    cls.add_method('GetMid', 
                   'ns3::oplsr::MessageHeader::Mid &', 
                   [])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Mid const & ns3::oplsr::MessageHeader::GetMid() const [member function]
    cls.add_method('GetMid', 
                   'ns3::oplsr::MessageHeader::Mid const &', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::Ipv4Address ns3::oplsr::MessageHeader::GetOriginatorAddress() const [member function]
    cls.add_method('GetOriginatorAddress', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc & ns3::oplsr::MessageHeader::GetTc() [member function]
    cls.add_method('GetTc', 
                   'ns3::oplsr::MessageHeader::Tc &', 
                   [])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc const & ns3::oplsr::MessageHeader::GetTc() const [member function]
    cls.add_method('GetTc', 
                   'ns3::oplsr::MessageHeader::Tc const &', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): uint8_t ns3::oplsr::MessageHeader::GetTimeToLive() const [member function]
    cls.add_method('GetTimeToLive', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): static ns3::TypeId ns3::oplsr::MessageHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## oplsr-header.h (module 'oplsr'): ns3::Time ns3::oplsr::MessageHeader::GetVTime() const [member function]
    cls.add_method('GetVTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::SetHopCount(uint8_t hopCount) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'hopCount')])
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::SetMessageSequenceNumber(uint16_t messageSequenceNumber) [member function]
    cls.add_method('SetMessageSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'messageSequenceNumber')])
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::SetMessageType(ns3::oplsr::MessageHeader::MessageType messageType) [member function]
    cls.add_method('SetMessageType', 
                   'void', 
                   [param('ns3::oplsr::MessageHeader::MessageType', 'messageType')])
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::SetOriginatorAddress(ns3::Ipv4Address originatorAddress) [member function]
    cls.add_method('SetOriginatorAddress', 
                   'void', 
                   [param('ns3::Ipv4Address', 'originatorAddress')])
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::SetTimeToLive(uint8_t timeToLive) [member function]
    cls.add_method('SetTimeToLive', 
                   'void', 
                   [param('uint8_t', 'timeToLive')])
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::SetVTime(ns3::Time time) [member function]
    cls.add_method('SetVTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    return

def register_Ns3OplsrMessageHeaderHello_methods(root_module, cls):
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::Hello() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::Hello(ns3::oplsr::MessageHeader::Hello const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader::Hello const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Hello::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## oplsr-header.h (module 'oplsr'): ns3::Time ns3::oplsr::MessageHeader::Hello::GetHTime() const [member function]
    cls.add_method('GetHTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Hello::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Hello::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Hello::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Hello::SetHTime(ns3::Time time) [member function]
    cls.add_method('SetHTime', 
                   'void', 
                   [param('ns3::Time', 'time')])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::hTime [variable]
    cls.add_instance_attribute('hTime', 'uint8_t', is_const=False)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::linkMessages [variable]
    cls.add_instance_attribute('linkMessages', 'std::vector< ns3::oplsr::MessageHeader::Hello::LinkMessage >', is_const=False)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3OplsrMessageHeaderHelloLinkMessage_methods(root_module, cls):
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::LinkMessage::LinkMessage() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::LinkMessage::LinkMessage(ns3::oplsr::MessageHeader::Hello::LinkMessage const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader::Hello::LinkMessage const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::LinkMessage::linkCode [variable]
    cls.add_instance_attribute('linkCode', 'uint8_t', is_const=False)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hello::LinkMessage::neighborInterfaceAddresses [variable]
    cls.add_instance_attribute('neighborInterfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3OplsrMessageHeaderHna_methods(root_module, cls):
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Hna() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Hna(ns3::oplsr::MessageHeader::Hna const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader::Hna const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Hna::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Hna::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Hna::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Hna::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::associations [variable]
    cls.add_instance_attribute('associations', 'std::vector< ns3::oplsr::MessageHeader::Hna::Association >', is_const=False)
    return

def register_Ns3OplsrMessageHeaderHnaAssociation_methods(root_module, cls):
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Association::Association() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Association::Association(ns3::oplsr::MessageHeader::Hna::Association const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader::Hna::Association const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Association::address [variable]
    cls.add_instance_attribute('address', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Hna::Association::mask [variable]
    cls.add_instance_attribute('mask', 'ns3::Ipv4Mask', is_const=False)
    return

def register_Ns3OplsrMessageHeaderMid_methods(root_module, cls):
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Mid::Mid() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Mid::Mid(ns3::oplsr::MessageHeader::Mid const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader::Mid const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Mid::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Mid::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Mid::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Mid::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Mid::interfaceAddresses [variable]
    cls.add_instance_attribute('interfaceAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3OplsrMessageHeaderTc_methods(root_module, cls):
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc::Tc() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc::Tc(ns3::oplsr::MessageHeader::Tc const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MessageHeader::Tc const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Tc::Deserialize(ns3::Buffer::Iterator start, uint32_t messageSize) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start'), param('uint32_t', 'messageSize')])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::MessageHeader::Tc::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Tc::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::MessageHeader::Tc::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc::ansn [variable]
    cls.add_instance_attribute('ansn', 'uint16_t', is_const=False)
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::MessageHeader::Tc::neighborAddresses [variable]
    cls.add_instance_attribute('neighborAddresses', 'std::vector< ns3::Ipv4Address >', is_const=False)
    return

def register_Ns3OplsrMprSelectorTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::MprSelectorTuple::MprSelectorTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::MprSelectorTuple::MprSelectorTuple(ns3::oplsr::MprSelectorTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::MprSelectorTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::MprSelectorTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::MprSelectorTuple::mainAddr [variable]
    cls.add_instance_attribute('mainAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3OplsrNeighborTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    cls.add_output_stream_operator()
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple::NeighborTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple::NeighborTuple(ns3::oplsr::NeighborTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::NeighborTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple::status [variable]
    cls.add_instance_attribute('status', 'ns3::oplsr::NeighborTuple::Status', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::NeighborTuple::willingness [variable]
    cls.add_instance_attribute('willingness', 'uint8_t', is_const=False)
    return

def register_Ns3OplsrOplsrState_methods(root_module, cls):
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::OplsrState::OplsrState(ns3::oplsr::OplsrState const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::OplsrState const &', 'arg0')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::OplsrState::OplsrState() [constructor]
    cls.add_constructor([])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseAssociation(ns3::oplsr::Association const & tuple) [member function]
    cls.add_method('EraseAssociation', 
                   'void', 
                   [param('ns3::oplsr::Association const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseAssociationTuple(ns3::oplsr::AssociationTuple const & tuple) [member function]
    cls.add_method('EraseAssociationTuple', 
                   'void', 
                   [param('ns3::oplsr::AssociationTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseDuplicateTuple(ns3::oplsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('EraseDuplicateTuple', 
                   'void', 
                   [param('ns3::oplsr::DuplicateTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseIfaceAssocTuple(ns3::oplsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('EraseIfaceAssocTuple', 
                   'void', 
                   [param('ns3::oplsr::IfaceAssocTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseLinkTuple(ns3::oplsr::LinkTuple const & tuple) [member function]
    cls.add_method('EraseLinkTuple', 
                   'void', 
                   [param('ns3::oplsr::LinkTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseMprSelectorTuple(ns3::oplsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('EraseMprSelectorTuple', 
                   'void', 
                   [param('ns3::oplsr::MprSelectorTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseMprSelectorTuples(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseMprSelectorTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseNeighborTuple(ns3::oplsr::NeighborTuple const & neighborTuple) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::oplsr::NeighborTuple const &', 'neighborTuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('EraseNeighborTuple', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseOlderTopologyTuples(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('EraseOlderTopologyTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseTopologyTuple(ns3::oplsr::TopologyTuple const & tuple) [member function]
    cls.add_method('EraseTopologyTuple', 
                   'void', 
                   [param('ns3::oplsr::TopologyTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseTwoHopNeighborTuple(ns3::oplsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('EraseTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::oplsr::TwoHopNeighborTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::EraseTwoHopNeighborTuples(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('EraseTwoHopNeighborTuples', 
                   'void', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::AssociationTuple * ns3::oplsr::OplsrState::FindAssociationTuple(ns3::Ipv4Address const & gatewayAddr, ns3::Ipv4Address const & networkAddr, ns3::Ipv4Mask const & netmask) [member function]
    cls.add_method('FindAssociationTuple', 
                   'ns3::oplsr::AssociationTuple *', 
                   [param('ns3::Ipv4Address const &', 'gatewayAddr'), param('ns3::Ipv4Address const &', 'networkAddr'), param('ns3::Ipv4Mask const &', 'netmask')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::DuplicateTuple * ns3::oplsr::OplsrState::FindDuplicateTuple(ns3::Ipv4Address const & address, uint16_t sequenceNumber) [member function]
    cls.add_method('FindDuplicateTuple', 
                   'ns3::oplsr::DuplicateTuple *', 
                   [param('ns3::Ipv4Address const &', 'address'), param('uint16_t', 'sequenceNumber')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple * ns3::oplsr::OplsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::oplsr::IfaceAssocTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::IfaceAssocTuple const * ns3::oplsr::OplsrState::FindIfaceAssocTuple(ns3::Ipv4Address const & ifaceAddr) const [member function]
    cls.add_method('FindIfaceAssocTuple', 
                   'ns3::oplsr::IfaceAssocTuple const *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::LinkTuple * ns3::oplsr::OplsrState::FindLinkTuple(ns3::Ipv4Address const & ifaceAddr) [member function]
    cls.add_method('FindLinkTuple', 
                   'ns3::oplsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr')])
    ## oplsr-state.h (module 'oplsr'): bool ns3::oplsr::OplsrState::FindMprAddress(ns3::Ipv4Address const & address) [member function]
    cls.add_method('FindMprAddress', 
                   'bool', 
                   [param('ns3::Ipv4Address const &', 'address')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::MprSelectorTuple * ns3::oplsr::OplsrState::FindMprSelectorTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindMprSelectorTuple', 
                   'ns3::oplsr::MprSelectorTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## oplsr-state.h (module 'oplsr'): std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > ns3::oplsr::OplsrState::FindNeighborInterfaces(ns3::Ipv4Address const & neighborMainAddr) const [member function]
    cls.add_method('FindNeighborInterfaces', 
                   'std::vector< ns3::Ipv4Address >', 
                   [param('ns3::Ipv4Address const &', 'neighborMainAddr')], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::NeighborTuple * ns3::oplsr::OplsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::oplsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::NeighborTuple * ns3::oplsr::OplsrState::FindNeighborTuple(ns3::Ipv4Address const & mainAddr, uint8_t willingness) [member function]
    cls.add_method('FindNeighborTuple', 
                   'ns3::oplsr::NeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr'), param('uint8_t', 'willingness')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::TopologyTuple * ns3::oplsr::OplsrState::FindNewerTopologyTuple(ns3::Ipv4Address const & lastAddr, uint16_t ansn) [member function]
    cls.add_method('FindNewerTopologyTuple', 
                   'ns3::oplsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'lastAddr'), param('uint16_t', 'ansn')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::LinkTuple * ns3::oplsr::OplsrState::FindSymLinkTuple(ns3::Ipv4Address const & ifaceAddr, ns3::Time time) [member function]
    cls.add_method('FindSymLinkTuple', 
                   'ns3::oplsr::LinkTuple *', 
                   [param('ns3::Ipv4Address const &', 'ifaceAddr'), param('ns3::Time', 'time')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::NeighborTuple const * ns3::oplsr::OplsrState::FindSymNeighborTuple(ns3::Ipv4Address const & mainAddr) const [member function]
    cls.add_method('FindSymNeighborTuple', 
                   'ns3::oplsr::NeighborTuple const *', 
                   [param('ns3::Ipv4Address const &', 'mainAddr')], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::TopologyTuple * ns3::oplsr::OplsrState::FindTopologyTuple(ns3::Ipv4Address const & destAddr, ns3::Ipv4Address const & lastAddr) [member function]
    cls.add_method('FindTopologyTuple', 
                   'ns3::oplsr::TopologyTuple *', 
                   [param('ns3::Ipv4Address const &', 'destAddr'), param('ns3::Ipv4Address const &', 'lastAddr')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple * ns3::oplsr::OplsrState::FindTwoHopNeighborTuple(ns3::Ipv4Address const & neighbor, ns3::Ipv4Address const & twoHopNeighbor) [member function]
    cls.add_method('FindTwoHopNeighborTuple', 
                   'ns3::oplsr::TwoHopNeighborTuple *', 
                   [param('ns3::Ipv4Address const &', 'neighbor'), param('ns3::Ipv4Address const &', 'twoHopNeighbor')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::AssociationSet const & ns3::oplsr::OplsrState::GetAssociationSet() const [member function]
    cls.add_method('GetAssociationSet', 
                   'ns3::oplsr::AssociationSet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::Associations const & ns3::oplsr::OplsrState::GetAssociations() const [member function]
    cls.add_method('GetAssociations', 
                   'ns3::oplsr::Associations const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::IfaceAssocSet const & ns3::oplsr::OplsrState::GetIfaceAssocSet() const [member function]
    cls.add_method('GetIfaceAssocSet', 
                   'ns3::oplsr::IfaceAssocSet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::IfaceAssocSet & ns3::oplsr::OplsrState::GetIfaceAssocSetMutable() [member function]
    cls.add_method('GetIfaceAssocSetMutable', 
                   'ns3::oplsr::IfaceAssocSet &', 
                   [])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::LinkSet const & ns3::oplsr::OplsrState::GetLinks() const [member function]
    cls.add_method('GetLinks', 
                   'ns3::oplsr::LinkSet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::MprSelectorSet const & ns3::oplsr::OplsrState::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::oplsr::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::MprSet ns3::oplsr::OplsrState::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::oplsr::MprSet', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::NeighborSet const & ns3::oplsr::OplsrState::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::oplsr::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::NeighborSet & ns3::oplsr::OplsrState::GetNeighbors() [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::oplsr::NeighborSet &', 
                   [])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::TopologySet const & ns3::oplsr::OplsrState::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::oplsr::TopologySet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborSet const & ns3::oplsr::OplsrState::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::oplsr::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborSet & ns3::oplsr::OplsrState::GetTwoHopNeighbors() [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::oplsr::TwoHopNeighborSet &', 
                   [])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertAssociation(ns3::oplsr::Association const & tuple) [member function]
    cls.add_method('InsertAssociation', 
                   'void', 
                   [param('ns3::oplsr::Association const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertAssociationTuple(ns3::oplsr::AssociationTuple const & tuple) [member function]
    cls.add_method('InsertAssociationTuple', 
                   'void', 
                   [param('ns3::oplsr::AssociationTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertDuplicateTuple(ns3::oplsr::DuplicateTuple const & tuple) [member function]
    cls.add_method('InsertDuplicateTuple', 
                   'void', 
                   [param('ns3::oplsr::DuplicateTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertIfaceAssocTuple(ns3::oplsr::IfaceAssocTuple const & tuple) [member function]
    cls.add_method('InsertIfaceAssocTuple', 
                   'void', 
                   [param('ns3::oplsr::IfaceAssocTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): ns3::oplsr::LinkTuple & ns3::oplsr::OplsrState::InsertLinkTuple(ns3::oplsr::LinkTuple const & tuple) [member function]
    cls.add_method('InsertLinkTuple', 
                   'ns3::oplsr::LinkTuple &', 
                   [param('ns3::oplsr::LinkTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertMprSelectorTuple(ns3::oplsr::MprSelectorTuple const & tuple) [member function]
    cls.add_method('InsertMprSelectorTuple', 
                   'void', 
                   [param('ns3::oplsr::MprSelectorTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertNeighborTuple(ns3::oplsr::NeighborTuple const & tuple) [member function]
    cls.add_method('InsertNeighborTuple', 
                   'void', 
                   [param('ns3::oplsr::NeighborTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertTopologyTuple(ns3::oplsr::TopologyTuple const & tuple) [member function]
    cls.add_method('InsertTopologyTuple', 
                   'void', 
                   [param('ns3::oplsr::TopologyTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::InsertTwoHopNeighborTuple(ns3::oplsr::TwoHopNeighborTuple const & tuple) [member function]
    cls.add_method('InsertTwoHopNeighborTuple', 
                   'void', 
                   [param('ns3::oplsr::TwoHopNeighborTuple const &', 'tuple')])
    ## oplsr-state.h (module 'oplsr'): std::string ns3::oplsr::OplsrState::PrintMprSelectorSet() const [member function]
    cls.add_method('PrintMprSelectorSet', 
                   'std::string', 
                   [], 
                   is_const=True)
    ## oplsr-state.h (module 'oplsr'): void ns3::oplsr::OplsrState::SetMprSet(ns3::oplsr::MprSet mprSet) [member function]
    cls.add_method('SetMprSet', 
                   'void', 
                   [param('std::set< ns3::Ipv4Address >', 'mprSet')])
    return

def register_Ns3OplsrPacketHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::PacketHeader::PacketHeader(ns3::oplsr::PacketHeader const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::PacketHeader const &', 'arg0')])
    ## oplsr-header.h (module 'oplsr'): ns3::oplsr::PacketHeader::PacketHeader() [constructor]
    cls.add_constructor([])
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::PacketHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): ns3::TypeId ns3::oplsr::PacketHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): uint16_t ns3::oplsr::PacketHeader::GetPacketLength() const [member function]
    cls.add_method('GetPacketLength', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): uint16_t ns3::oplsr::PacketHeader::GetPacketSequenceNumber() const [member function]
    cls.add_method('GetPacketSequenceNumber', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## oplsr-header.h (module 'oplsr'): uint32_t ns3::oplsr::PacketHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): static ns3::TypeId ns3::oplsr::PacketHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::PacketHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::PacketHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::PacketHeader::SetPacketLength(uint16_t length) [member function]
    cls.add_method('SetPacketLength', 
                   'void', 
                   [param('uint16_t', 'length')])
    ## oplsr-header.h (module 'oplsr'): void ns3::oplsr::PacketHeader::SetPacketSequenceNumber(uint16_t seqnum) [member function]
    cls.add_method('SetPacketSequenceNumber', 
                   'void', 
                   [param('uint16_t', 'seqnum')])
    return

def register_Ns3OplsrRoutingProtocol_methods(root_module, cls):
    ## oplsr-routing-protocol.h (module 'oplsr'): static ns3::TypeId ns3::oplsr::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::SetMainInterface(uint32_t interface) [member function]
    cls.add_method('SetMainInterface', 
                   'void', 
                   [param('uint32_t', 'interface')])
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::Dump() [member function]
    cls.add_method('Dump', 
                   'void', 
                   [])
    ## oplsr-routing-protocol.h (module 'oplsr'): std::vector<ns3::oplsr::RoutingTableEntry, std::allocator<ns3::oplsr::RoutingTableEntry> > ns3::oplsr::RoutingProtocol::GetRoutingTableEntries() const [member function]
    cls.add_method('GetRoutingTableEntries', 
                   'std::vector< ns3::oplsr::RoutingTableEntry >', 
                   [], 
                   is_const=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): int64_t ns3::oplsr::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## oplsr-routing-protocol.h (module 'oplsr'): std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > ns3::oplsr::RoutingProtocol::GetInterfaceExclusions() const [member function]
    cls.add_method('GetInterfaceExclusions', 
                   'std::set< unsigned int >', 
                   [], 
                   is_const=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::SetInterfaceExclusions(std::set<unsigned int, std::less<unsigned int>, std::allocator<unsigned int> > exceptions) [member function]
    cls.add_method('SetInterfaceExclusions', 
                   'void', 
                   [param('std::set< unsigned int >', 'exceptions')])
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::AddHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('AddHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::RemoveHostNetworkAssociation(ns3::Ipv4Address networkAddr, ns3::Ipv4Mask netmask) [member function]
    cls.add_method('RemoveHostNetworkAssociation', 
                   'void', 
                   [param('ns3::Ipv4Address', 'networkAddr'), param('ns3::Ipv4Mask', 'netmask')])
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::SetRoutingTableAssociation(ns3::Ptr<ns3::Ipv4StaticRouting> routingTable) [member function]
    cls.add_method('SetRoutingTableAssociation', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4StaticRouting >', 'routingTable')])
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::Ptr<const ns3::Ipv4StaticRouting> ns3::oplsr::RoutingProtocol::GetRoutingTableAssociation() const [member function]
    cls.add_method('GetRoutingTableAssociation', 
                   'ns3::Ptr< ns3::Ipv4StaticRouting const >', 
                   [], 
                   is_const=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingProtocol::RoutingProtocol(ns3::oplsr::RoutingProtocol const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::RoutingProtocol const &', 'arg0')])
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::DoInitialize() [member function]
    cls.add_method('DoInitialize', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::Ptr<ns3::Ipv4Route> ns3::oplsr::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): bool ns3::oplsr::RoutingProtocol::RouteInput(ns3::Ptr<const ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Ipv4RoutingProtocol::UnicastForwardCallback ucb, ns3::Ipv4RoutingProtocol::MulticastForwardCallback mcb, ns3::Ipv4RoutingProtocol::LocalDeliverCallback lcb, ns3::Ipv4RoutingProtocol::ErrorCallback ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream, ns3::Time::Unit unit=::ns3::Time::Unit::S) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, visibility='private', is_virtual=True)
    ## oplsr-routing-protocol.h (module 'oplsr'): void ns3::oplsr::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='private', is_virtual=True)
...
def register_Ns3OplsrRoutingTableEntry_methods(root_module, cls):
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry::RoutingTableEntry(ns3::oplsr::RoutingTableEntry const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::RoutingTableEntry const &', 'arg0')])
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry::RoutingTableEntry() [constructor]
    cls.add_constructor([])
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry::distance [variable]
    cls.add_instance_attribute('distance', 'uint32_t', is_const=False)
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry::interface [variable]
    cls.add_instance_attribute('interface', 'uint32_t', is_const=False)
    ## oplsr-routing-protocol.h (module 'oplsr'): ns3::oplsr::RoutingTableEntry::nextAddr [variable]
    cls.add_instance_attribute('nextAddr', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3OplsrTopologyTuple_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    cls.add_output_stream_operator()
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple::TopologyTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple::TopologyTuple(ns3::oplsr::TopologyTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::TopologyTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple::destAddr [variable]
    cls.add_instance_attribute('destAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple::lastAddr [variable]
    cls.add_instance_attribute('lastAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TopologyTuple::sequenceNumber [variable]
    cls.add_instance_attribute('sequenceNumber', 'uint16_t', is_const=False)
    return

def register_Ns3OplsrTwoHopNeighborTuple_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple::TwoHopNeighborTuple() [constructor]
    cls.add_constructor([])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple::TwoHopNeighborTuple(ns3::oplsr::TwoHopNeighborTuple const & arg0) [constructor]
    cls.add_constructor([param('ns3::oplsr::TwoHopNeighborTuple const &', 'arg0')])
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple::expirationTime [variable]
    cls.add_instance_attribute('expirationTime', 'ns3::Time', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple::neighborMainAddr [variable]
    cls.add_instance_attribute('neighborMainAddr', 'ns3::Ipv4Address', is_const=False)
    ## oplsr-repositories.h (module 'oplsr'): ns3::oplsr::TwoHopNeighborTuple::twoHopNeighborAddr [variable]
...
def register_functions(root_module):
    ...
    register_functions_ns3_oplsr(module.add_cpp_namespace('oplsr'), root_module)
...
def register_functions_ns3_oplsr(module, root_module):
    ## oplsr-header.h (module 'oplsr'): double ns3::oplsr::EmfToSeconds(uint8_t emf) [free function]
    module.add_function('EmfToSeconds', 
                        'double', 
                        [param('uint8_t', 'emf')])
    ## oplsr-header.h (module 'oplsr'): uint8_t ns3::oplsr::SecondsToEmf(double seconds) [free function]
