...
//
// Simple example of OPLSR routing over some point-to-point links
//
// Network topology
//
//   n0
...
// - DropTail queues
// - Tracing of queues and packet receptions to file "simple-point-to-point-oplsr.tr"
...
#include "ns3/oplsr-helper.h"
#include "ns3/ipv4-static-routing-helper.h"
#include "ns3/ipv4-list-routing-helper.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("SimplePointToPointOplsrExample");
...
main (int argc, char *argv[])
{
  ...
  // Enable OPLSR
  NS_LOG_INFO ("Enabling OPLSR Routing.");
  OplsrHelper oplsr;
  ...
  p2p.EnableAsciiAll (ascii.CreateFileStream ("simple-point-to-point-oplsr.tr"));
  p2p.EnablePcapAll ("simple-point-to-point-oplsr");
