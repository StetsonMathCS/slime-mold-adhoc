...
MprSelectorTuple*
OplsrState::FindMprSelectorTuple (Ipv4Address const &mainAddr)
{
...
void
OplsrState::EraseMprSelectorTuple (const MprSelectorTuple &tuple)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
       it != m_mprSelectorSet.end (); it++)
    {
...
void
OplsrState::EraseMprSelectorTuples (const Ipv4Address &mainAddr)
{
  for (MprSelectorSet::iterator it = m_mprSelectorSet.begin ();
...
void
OplsrState::InsertMprSelectorTuple (MprSelectorTuple const &tuple)
{
  m_mprSelectorSet.push_back (tuple);
}

std::string
OplsrState::PrintMprSelectorSet () const
{
...
NeighborTuple*
OplsrState::FindNeighborTuple (Ipv4Address const &mainAddr)
{
...
const NeighborTuple*
OplsrState::FindSymNeighborTuple (Ipv4Address const &mainAddr) const
{
...
NeighborTuple*
OplsrState::FindNeighborTuple (Ipv4Address const &mainAddr, uint8_t willingness)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
OplsrState::EraseNeighborTuple (const NeighborTuple &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
OplsrState::EraseNeighborTuple (const Ipv4Address &mainAddr)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
void
OplsrState::InsertNeighborTuple (NeighborTuple const &tuple)
{
  for (NeighborSet::iterator it = m_neighborSet.begin ();
       it != m_neighborSet.end (); it++)
    {
...
TwoHopNeighborTuple*
OplsrState::FindTwoHopNeighborTuple (Ipv4Address const &neighborMainAddr,
...
void
OplsrState::EraseTwoHopNeighborTuple (const TwoHopNeighborTuple &tuple)
{
  for (TwoHopNeighborSet::iterator it = m_twoHopNeighborSet.begin ();
       it != m_twoHopNeighborSet.end (); it++)
    {
...
void
OplsrState::EraseTwoHopNeighborTuples (const Ipv4Address &neighborMainAddr,
...
void
OplsrState::InsertTwoHopNeighborTuple (TwoHopNeighborTuple const &tuple)
{
...
bool
OplsrState::FindMprAddress (Ipv4Address const &addr)
{
...
void
OplsrState::SetMprSet (MprSet mprSet)
{
  m_mprSet = mprSet;
}
MprSet
OplsrState::GetMprSet () const
{
  return m_mprSet;
}
...
DuplicateTuple*
OplsrState::FindDuplicateTuple (Ipv4Address const &addr, uint16_t sequenceNumber)
{
...
void
OplsrState::EraseDuplicateTuple (const DuplicateTuple &tuple)
{
  for (DuplicateSet::iterator it = m_duplicateSet.begin ();
       it != m_duplicateSet.end (); it++)
    {
...
void
OplsrState::InsertDuplicateTuple (DuplicateTuple const &tuple)
{
...
LinkTuple*
OplsrState::FindLinkTuple (Ipv4Address const & ifaceAddr)
{
...
LinkTuple*
OplsrState::FindSymLinkTuple (Ipv4Address const &ifaceAddr, Time now)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
void
OplsrState::EraseLinkTuple (const LinkTuple &tuple)
{
  for (LinkSet::iterator it = m_linkSet.begin ();
       it != m_linkSet.end (); it++)
    {
...
LinkTuple&
OplsrState::InsertLinkTuple (LinkTuple const &tuple)
{
...
TopologyTuple*
OplsrState::FindTopologyTuple (Ipv4Address const &destAddr,
...
TopologyTuple*
OplsrState::FindNewerTopologyTuple (Ipv4Address const & lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
OplsrState::EraseTopologyTuple (const TopologyTuple &tuple)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
       it != m_topologySet.end (); it++)
    {
...
void
OplsrState::EraseOlderTopologyTuples (const Ipv4Address &lastAddr, uint16_t ansn)
{
  for (TopologySet::iterator it = m_topologySet.begin ();
...
void
OplsrState::InsertTopologyTuple (TopologyTuple const &tuple)
{
...
IfaceAssocTuple*
OplsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr)
{
...
OplsrState::FindIfaceAssocTuple (Ipv4Address const &ifaceAddr) const
{
...
void
OplsrState::EraseIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  for (IfaceAssocSet::iterator it = m_ifaceAssocSet.begin ();
       it != m_ifaceAssocSet.end (); it++)
    {
...
void
OplsrState::InsertIfaceAssocTuple (const IfaceAssocTuple &tuple)
{
  m_ifaceAssocSet.push_back (tuple);
}

std::vector<Ipv4Address>
OplsrState::FindNeighborInterfaces (const Ipv4Address &neighborMainAddr) const
{
...
AssociationTuple*
OplsrState::FindAssociationTuple (const Ipv4Address &gatewayAddr, const Ipv4Address &networkAddr, const Ipv4Mask &netmask)
{
...
void
OplsrState::EraseAssociationTuple (const AssociationTuple &tuple)
{
  for (AssociationSet::iterator it = m_associationSet.begin ();
       it != m_associationSet.end (); it++)
    {
...
void
OplsrState::InsertAssociationTuple (const AssociationTuple &tuple)
{
  m_associationSet.push_back (tuple);
}

void
OplsrState::EraseAssociation (const Association &tuple)
{
...
void
OplsrState::InsertAssociation (const Association &tuple)
{
