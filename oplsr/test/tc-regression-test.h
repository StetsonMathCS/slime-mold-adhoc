 ...
 * \ingroup tests
 *
 * \brief Less trivial test of OPLSR Topology Control message generation
 *
 * This test simulates 3 Wi-Fi stations with chain topology and runs OPLSR without any extra traffic.
