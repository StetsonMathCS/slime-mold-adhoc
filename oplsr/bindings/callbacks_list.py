callback_classes = [
    ...
    ['void', 'const ns3::oplsr::PacketHeader &', 'const std::vector<ns3::oplsr::MessageHeader, std::allocator<ns3::oplsr::MessageHeader> > &', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'],
]
