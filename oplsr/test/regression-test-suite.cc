 ...
 * \ingroup tests
 *
 * Various oplsr regression tests
 */
class RegressionTestSuite : public TestSuite
{
public:
  RegressionTestSuite () : TestSuite ("routing-oplsr-regression", SYSTEM)
  {
...
static RegressionTestSuite g_oplsrRegressionTestSuite; //!< Static variable for test initialization
